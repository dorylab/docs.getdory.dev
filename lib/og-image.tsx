    ...
    >
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(circle at 50% 14%, rgba(255, 255, 255, 0.07), transparent 28%), radial-gradient(circle at 50% 92%, rgba(54, 91, 155, 0.12), transparent 42%), linear-gradient(180deg, #050505 0%, #090a0d 100%)",
        }}
      />
      <div
        style={{
