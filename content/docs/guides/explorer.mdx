...
Explorer is upstream of the rest of the workflow. It helps validate structure for [Connections](./connections), improves SQL authoring in [SQL Console](./sql-editor), and makes AI prompts more concrete in [AI Chat](./ai-chat).
